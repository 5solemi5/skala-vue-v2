      ...
      -->
        ...
        -->
          ...
          <g v-else-if="look.hat === 4" class="gear">
            <!-- 머리띠와 리본 -->
            <path d="M5.1 4.6 A7 6.6 0 0 1 18.9 4.6 L18.2 6.1 A6.4 6 0 0 0 5.8 6.1 Z" />
            <path d="M17.9 2.7 L21.9 0.5 L21.4 5 Z" />
            <path d="M17.9 2.7 L22.9 4 L20.7 6.8 Z" />
            <circle class="pip" cx="18.3" cy="3.5" r="1.25" />
          </g>
