          ...
          <g v-else-if="look.hat === 4" class="gear">
            <!--
              ...
              여기까지 세 번 갈아엎었다.
                ...
                앞머리 몇 가닥을 깔아 봤지만 가닥과 막대가 붙어 더 지저분했다

              한 덩어리로 알아볼 수 있는 모양이라야 한다.
              작아지면 세부는 다 뭉개지고 실루엣만 남기 때문이다.
              하트는 그 크기에서도 하트다.
            -->
            <path
              class="pin"
              d="M15.6 4.6 C12.9 2.9 13.1 0.5 14.7 0.5 C15.35 0.5 15.6 1.1 15.6 1.1 C15.6 1.1 15.85 0.5 16.5 0.5 C18.1 0.5 18.3 2.9 15.6 4.6 Z"
            />
          </g>
